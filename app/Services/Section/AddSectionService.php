...
class AddSectionService
{
    ...
    public function handle(string $name, TelegraphChat $chat): void
    {
        ...
        $chat->message("✅ Раздел $name добавлен!")->send();
        $chat->message("Теперь вы можете создавать задачи, фильтровать их, экспортировать и многое другое. Просто используйте голос или текст!")->send();
    }
}
